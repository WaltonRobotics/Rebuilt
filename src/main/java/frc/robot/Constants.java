...
public class Constants {
    ...
    public static class AutonK {
        public static final Pose2d rightNeutralPose = new Pose2d(Distance.ofRelativeUnits(6.924767017364502, Meter), 
            Distance.ofRelativeUnits(2.251265048980713, Meter), new Rotation2d(0));
        public static final Pose2d rightDepotPose = new Pose2d(Distance.ofRelativeUnits(1.1576627492904663, Meter), 
