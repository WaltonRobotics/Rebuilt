...
public class Indexer extends SubsystemBase {
    ...
    private final TalonFX m_spinner = new TalonFX(kSpinnerCANID, Constants.kCanivoreBus); // X60
    private final TalonFX m_exhaust = new TalonFX(kExhaustCANID, Constants.kCanivoreBus); // X60
