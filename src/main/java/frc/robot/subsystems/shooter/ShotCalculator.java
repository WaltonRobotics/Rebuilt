...
public class ShotCalculator {
    ...
    static {
        ...
        //spoof table
        // shot.add(8.627, 69.000, 1.160, 1.65, 0.500);
        // shot.add(7.801, 65.865, 1.106, 1.524, 0.500);
        // shot.add(6.973, 62.723, 1.046, 1.411, 0.500);
        // shot.add(6.126, 59.509, 0.977, 1.308, 0.500);
        // shot.add(5.577, 57.426, 0.927, 1.249, 0.500);
        // shot.add(4.555, 53.548, 0.819, 1.153, 0.500);
        // shot.add(4.231, 52.318, 0.779, 1.127, 0.500);
        // shot.add(3.798, 50.675, 0.721, 1.095, 0.500);
        // shot.add(3.267, 48.660, 0.641, 1.060, 0.500);
        // shot.add(2.826, 46.986, 0.563, 1.035, 0.500);
        // shot.add(2.212, 44.656, 0.432, 1.006, 0.500);
        // shot.add(1.929, 43.582, 0.359, 0.995, 0.500);
        // shot.add(1.093, 40.410, 0.056, 0.972, 0.500);
        // shot.add(0.985, 40.000, 0.000, 0.97, 0.500);
