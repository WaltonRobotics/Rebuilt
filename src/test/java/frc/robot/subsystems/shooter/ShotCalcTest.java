...
class ShotCalcTest {
    ...
    class CalcShot {
        ...
        void staticVsDynamic_sameWhenStationary() {
            ...
            assertEquals(
                ...
                dynamicOut.shooterReferenceRotPerSec(),
    ...
    private static void assertAzimuthValid(AzimuthCalcDetails details) {
        ...
        assertFalse(Double.isNaN(details.turretVelocityFFRotPerSec()),
    ...
    private static void assertShotCalcOutputsValid(ShotCalcOutputs out) {
        ...
        assertFalse(Double.isNaN(out.shooterReferenceRotPerSec()),
            "Shooter reference should not be NaN");
        assertTrue(out.shooterReferenceRotPerSec() >= 0,
